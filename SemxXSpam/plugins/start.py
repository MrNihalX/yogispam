...
RYAN_IMG = "https://telegra.ph/file/49f8407bd8708b5a07e75.jpg"

Ryan_Button = [
        [
        Button.url("✨ sᴜᴘᴘᴏʀᴛ ✨", "https://t.me/Mr_Nihal9")
        ],
        [
...
RyanX_Button = [
        [
        Button.url("✨ ᴄʜᴀɴɴᴇʟ ✨", "https://t.me/REDOXMOD"),
        Button.url("✨ sᴜᴘᴘᴏʀᴛ ✨", "https://t.me/Mr_Nihal9")
        ],
        [
        Button.url("🔥 ʀᴇᴘᴏ 🔥", "https://github.com/MrNihalX/SPAM-LOVE")
        ]
        ]
